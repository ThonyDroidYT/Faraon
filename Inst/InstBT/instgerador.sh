...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/ThonyDroidYT/Faraon/main/CRTL/IP-Crtl")
  [[ $(echo $permited|grep "${IP}") = "" ]] && {
  echo -e "\n\n\n\033[1;31m====================================================="
  echo -e "\033[1;31m       ¡LA IP $(wget -qO- ipv4.icanhazip.com) NO ESTA AUTORIZADA!"
  echo -e "\033[1;31m                CONTACTE A @ThonyDroidYT"
  echo -e "\033[1;31m=====================================================\n\n\n"
  [[ -d /etc/SCRIPT ]] && rm -rf /etc/SCRIPT
  exit 1
  } || {
  ### INTALAR VERCION DE SCRIPT
  v1=$(curl -sSL "https://raw.githubusercontent.com/ThonyDroidYT/Faraon/main/Vercion")
...
wget -O /etc/SCRIPT/bot.sh https://raw.githubusercontent.com/ThonyDroidYT/Faraon/main/BT/bot.sh &>/dev/null
wget https://raw.githubusercontent.com/ThonyDroidYT/ADMGenPro/master/SCRIPT/gerar.sh &>/dev/null
